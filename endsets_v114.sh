...
#
# Change Log: - Fixed ip error in ipv6 blacklist 
...
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --sports 80,443 -j LOG --log-prefix "[HTTP-BL OUT] "  --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --sports 80,443 -j DROP;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --dports 80,443 -j LOG --log-prefix "[HTTP-BL OUT] "  --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --dports 80,443 -j DROP;

iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --dports 80,443 -j LOG --log-prefix "[HTTP-BL IN] " --log-level=info;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --dports 80,443 -j DROP;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --sports 80,443 -j LOG --log-prefix "[HTTP-BL IN] " --log-level=info;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --sports 80,443 -j DROP;

iptables -I FORWARD  -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --dports 80,443 -j LOG --log-prefix "[HTTP-BL FORWARD IN] "  --log-level=info;
iptables -I FORWARD  -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --dports 80,443 -j DROP;
iptables -I FORWARD  -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --sports 80,443 -j LOG --log-prefix "[HTTP-BL FORWARD IN] "  --log-level=info;
iptables -I FORWARD  -p tcp -d $int_ip1 -m set --match-set http_blacklist src -m multiport --sports 80,443 -j DROP;

iptables -I FORWARD  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --sports 80,443 -j LOG --log-prefix "[HTTP-BL FORWARD OUT] " --log-level=info;
iptables -I FORWARD  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --sports 80,443 -j DROP;
iptables -I FORWARD  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --dports 80,443 -j LOG --log-prefix "[HTTP-BL FORWARD OUT] " --log-level=info;
iptables -I FORWARD  -p tcp -s $int_ip1 -m set --match-set http_blacklist dst -m multiport --dports 80,443 -j DROP;

echo HTTP BLACKLIST LOADED

echo SMTP BLACKLIST LOADING

iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_blacklist dst -m multiport --sports 25,587 -j LOG --log-prefix "[SMTP-BL OUT] " --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_blacklist dst -m multiport --sports 25,587 -j DROP;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_blacklist dst -m multiport --dports 25,587 -j LOG --log-prefix "[SMTP-BL OUT] " --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_blacklist dst -m multiport --dports 25,587 -j DROP;

iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set smtp_blacklist src -m multiport --dports 25,587 -j LOG --log-prefix "[SMTP-BL IN] " --log-level=info;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set smtp_blacklist src -m multiport --dports 25,587 -j DROP;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set smtp_blacklist src -m multiport --sports 25,587 -j LOG --log-prefix "[SMTP-BL IN] " --log-level=info;
iptables -I INPUT  27 -p tcp -d $int_ip1 -m set --match-set smtp_blacklist src -m multiport --sports 25,587 -j DROP;
...
iptables -I OUTPUT  -p udp -s $int_ip1 -m set --match-set dns_blacklist dst --dport 53 -j LOG --log-prefix "[DNS-BL UDP OUT] " --log-level=info;
iptables -I OUTPUT  -p udp -s $int_ip1 -m set --match-set dns_blacklist dst --dport 53 -j DROP;
iptables -I OUTPUT  -p udp -s $int_ip1 -m set --match-set dns_blacklist dst --sport 53 -j LOG --log-prefix "[DNS-BL UDP OUT] " --log-level=info;
iptables -I OUTPUT  -p udp -s $int_ip1 -m set --match-set dns_blacklist dst --sport 53 -j DROP;

iptables -I INPUT  27 -p udp -d $int_ip1 -m set --match-set dns_blacklist src --dport 53 -j LOG --log-prefix "[DNS-BL UDP IN] " --log-level=info;
iptables -I INPUT  27 -p udp -d $int_ip1 -m set --match-set dns_blacklist src --dport 53 -j DROP;
iptables -I INPUT  27 -p udp -d $int_ip1 -m set --match-set dns_blacklist src --sport 53 -j LOG --log-prefix "[DNS-BL UDP IN] " --log-level=info;
iptables -I INPUT  27 -p udp -d $int_ip1 -m set --match-set dns_blacklist src --sport 53 -j DROP;
...
iptables -I OUTPUT -p tcp -s $int_ip1 -m set --match-set dns_blacklist dst --dport 53 -j LOG --log-prefix "[DNS-BL TCP OUT] " --log-level=info;
iptables -I OUTPUT -p tcp -s $int_ip1 -m set --match-set dns_blacklist dst --dport 53 -j DROP;
iptables -I OUTPUT -p tcp -s $int_ip1 -m set --match-set dns_blacklist dst --sport 53 -j LOG --log-prefix "[DNS-BL TCP OUT] " --log-level=info;
iptables -I OUTPUT -p tcp -s $int_ip1 -m set --match-set dns_blacklist dst --sport 53 -j DROP;

iptables -I INPUT 27 -p tcp -d $int_ip1 -m set --match-set dns_blacklist src --dport 53 -j LOG --log-prefix "[DNS-BL TCP IN] " --log-level=info;
iptables -I INPUT 27 -p tcp -d $int_ip1 -m set --match-set dns_blacklist src --dport 53 -j DROP;
iptables -I INPUT 27 -p tcp -d $int_ip1 -m set --match-set dns_blacklist src --sport 53 -j LOG --log-prefix "[DNS-BL TCP IN] " --log-level=info;
iptables -I INPUT 27 -p tcp -d $int_ip1 -m set --match-set dns_blacklist src --sport 53 -j DROP;
...
iptables -I OUTPUT   -p all -s $int_ip1 -m set --match-set attackers dst -j LOG --log-prefix "[ATTACKER OUT] "  --log-level=info; 
iptables -I OUTPUT   -p all -s $int_ip1 -m set --match-set attackers dst -j DROP;
iptables -I INPUT 27 -p all -d $int_ip1 -m set --match-set attackers src -j LOG --log-prefix "[ATTACKER IN] "  --log-level=info;
iptables -I INPUT 27 -p all -d $int_ip1 -m set --match-set attackers src -j DROP;
iptables -I FORWARD  -p all -d $int_ip1 -m set --match-set attackers src -j LOG --log-prefix "[ATTACKER FORWARD IN] "  --log-level=info;
iptables -I FORWARD  -p all -d $int_ip1 -m set --match-set attackers src -j DROP;
iptables -I FORWARD  -p all -s $int_ip1 -m set --match-set attackers dst -j LOG --log-prefix "[ATTACKER FORWARD OUT] "  --log-level=info;
iptables -I FORWARD  -p all -s $int_ip1 -m set --match-set attackers dst -j DROP;

echo ATTACKER BLACKLIST LOADED

echo LOADING BLACKLIST 

iptables -I OUTPUT   -p all -m set --match-set blacklist dst -j LOG --log-prefix "[BLACKLIST OUT] "  --log-level=info; 
iptables -I OUTPUT   -p all -m set --match-set blacklist dst -j DROP;
iptables -I INPUT 27 -p all -m set --match-set blacklist src -j LOG --log-prefix "[BLACKLIST IN] "  --log-level=info;
iptables -I INPUT 27 -p all -m set --match-set blacklist src -j DROP;
...
ip6tables -I OUTPUT   -p all -m set --match-set ipv6_blacklist dst -j LOG --log-prefix "[IPv6-BLACKLIST OUT] "  --log-level=info; 
ip6tables -I OUTPUT   -p all -m set --match-set ipv6_blacklist dst -j DROP;
ip6tables -I INPUT 27 -p all -m set --match-set ipv6_blacklist src -j LOG --log-prefix "[IPv6-BLACKLIST IN] "  --log-level=info;
ip6tables -I INPUT 27 -p all -m set --match-set ipv6_blacklist src -j DROP;
ip6tables -I FORWARD  -p all -m set --match-set ipv6_blacklist src -j LOG --log-prefix "[IPv6-BLACKLIST FORWARD IN] "  --log-level=info;
ip6tables -I FORWARD  -p all -m set --match-set ipv6_blacklist src -j DROP;
ip6tables -I FORWARD  -p all -m set --match-set ipv6_blacklist dst -j LOG --log-prefix "[IPv6-BLACKLIST FORWARD OUT] "  --log-level=info;
ip6tables -I FORWARD  -p all -m set --match-set ipv6_blacklist dst -j DROP;
...
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_whitelist dst -m multiport --dports 25,587 -j LOG --log-prefix "[SMTP-WL OUT] " --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set smtp_whitelist dst -m multiport --dports 25,587 -j ACCEPT;
iptables -I INPUT 27  -p tcp -d $int_ip1 -m set --match-set smtp_whitelist src -m multiport --dports 25,587 -j LOG --log-prefix "[SMTP-WL IN] " --log-level=info;
iptables -I INPUT 27  -p tcp -d $int_ip1 -m set --match-set smtp_whitelist src -m multiport --dports 25,587 -j ACCEPT; 
echo SMTP WHITELIST LOADED

echo HTTP/HTTPS WHITELIST LOADING

iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_whitelist dst -m multiport --dports 80,443 -j LOG --log-prefix "[HTTPS-WL OUT] " --log-level=info;
iptables -I OUTPUT  -p tcp -s $int_ip1 -m set --match-set http_whitelist dst -m multiport --dports 80,443 -j ACCEPT;
iptables -I INPUT 27  -p tcp -d $int_ip1 -m set --match-set http_whitelist src -m multiport --dports 80,443 -j LOG --log-prefix "[HTTPS-WL IN] " --log-level=info;
iptables -I INPUT 27  -p tcp -d $int_ip1 -m set --match-set http_whitelist src -m multiport --dports 80,443 -j ACCEPT;
